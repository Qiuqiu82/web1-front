const Api = {
  ...
  cosorderCommSessionPage: '/cosorder/comm/session/page',
  cosorderCommMessagePage: '/cosorder/comm/message/page',
  cosorderCommSend: '/cosorder/comm/send',
  cosorderCommDelivery: '/cosorder/comm/delivery',
