...
public class PayChannel4WechatImpl implements PayChannelService {
    ...
    public static String sign(String str, String keyPath) throws BusinessException {
        try {
    ...
    private static PrivateKey getPrivateKey(String filename) throws BusinessException {
        try {
